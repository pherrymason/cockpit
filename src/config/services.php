...
$services = [
    ...
    'mongo' => function (ContainerInterface $c) {
        ...
        return new \Cockpit\Framework\Database\MongoDB\Mongo(
            $config['server'],
            $config['options'],
    ...
    \League\Plates\Engine::class => function (ContainerInterface $c) {
        $factory = $c->get(\Cockpit\Framework\TemplateEngineFactory::class);
...
$cockpitServices = require(dirname(__DIR__) . '/Cockpit/App/config/services.php');
